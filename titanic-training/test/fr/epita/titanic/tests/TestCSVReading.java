...
//    }
    ...
    private static void givenTheTestFile_ThenTheCSVReaderShouldExtractAllTheLines() throws Exception{
        //given
        //List<String> lines = Files.readAllLines(Paths.get("./titanic-training/test.csv"));
        List<String> lines = Files.readAllLines(Paths.get("D:/MSc EPITA/Java and UML/2021-t3-java-uml-ais-master (1)/2021-t3-java-uml-ais-master/titanic-training/test.csv"));
